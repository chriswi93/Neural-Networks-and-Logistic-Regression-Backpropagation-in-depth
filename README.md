...
In the context of optimization a computation graph is the application of the chain rule in calculus. 
<p align="center">
...
Now we only have to multiply all gradients. As we compute the sum of all gradients in our data set we also multiply it by the inverse of m to compute the average gradient for data set x.

<a href="https://www.codecogs.com/eqnedit.php?latex=\dpi{120}&space;\newline\frac{\partial&space;L}{\partial&space;w}&space;=&space;\frac{1}{m}\left&space;(&space;\frac{\partial&space;L}{\partial&space;g}\frac{\partial&space;g}{\partial&space;z}\frac{\partial&space;z}{\partial&space;w}\right&space;)&space;\newline\frac{\partial&space;L}{\partial&space;b}&space;=&space;\frac{1}{m}\left&space;(&space;\frac{\partial&space;L}{\partial&space;g}\frac{\partial&space;g}{\partial&space;z}\frac{\partial&space;z}{\partial&space;b}\right&space;)" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\dpi{120}&space;\newline\frac{\partial&space;L}{\partial&space;w}&space;=&space;\frac{1}{m}\left&space;(&space;\frac{\partial&space;L}{\partial&space;g}\frac{\partial&space;g}{\partial&space;z}\frac{\partial&space;z}{\partial&space;w}\right&space;)&space;\newline\frac{\partial&space;L}{\partial&space;b}&space;=&space;\frac{1}{m}\left&space;(&space;\frac{\partial&space;L}{\partial&space;g}\frac{\partial&space;g}{\partial&space;z}\frac{\partial&space;z}{\partial&space;b}\right&space;)" title="\newline\frac{\partial L}{\partial w} = \frac{1}{m}\left ( \frac{\partial L}{\partial g}\frac{\partial g}{\partial z}\frac{\partial z}{\partial w}\right ) \newline\frac{\partial L}{\partial b} = \frac{1}{m}\left ( \frac{\partial L}{\partial g}\frac{\partial g}{\partial z}\frac{\partial z}{\partial b}\right )" /></a>
